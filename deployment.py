...
encoded_user_input_senior_citizen = label_encoder.fit_transfor([user_input_senior_citizen])
encoded_user_input_phone_service = label_encoder.fit_transform([user_input_phone_service])
encoded_user_input_multiple_lines = label_encoder.fit_transform([user_input_multiple_lines])
encoded_user_input_streaming_tv = label_encoder.fit_transform([user_input_streaming_tv])
encoded_user_input_streaming_movies = label_encoder.fit_transform([user_input_streaming_movies])
encoded_user_input_paperless_billing = label_encoder.fit_transform([user_input_paperless_billing])
encoded_user_input_payment_method = label_encoder.fit_transform([user_input_payment_method])
scaled_user_monthly_charges = scaler.fit_transform([[user_input_monthly_charges]])
